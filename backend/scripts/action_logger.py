"""
Action logger
Records actions of each agent during OASIS simulations for backend monitoring.
...
class SimulationLogManager:
    ...
    Central manager for all simulation-related log files, separated by platform.
    """
...
# ============ Compatibility: legacy interface ============
...
def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Get the global ActionLogger instance (legacy compatibility)"""
