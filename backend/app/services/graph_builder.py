...
Interface 2: build a Standalone Graph using Zep API
"""
...
class GraphBuilderService:
    """
    Graph building service
    Responsible for calling Zep API to construct knowledge graphs
    """
    ...
    def build_graph_async(
        ...
        graph_name: str = "ThinkSwarm Graph",
        chunk_size: int = 500,
    ...
    def create_graph(self, name: str) -> str:
        ...
        graph_id = f"ThinkSwarm_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="ThinkSwarm Social Simulation Graph"
        )
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required by the Zep SDK for dynamic class creation and can be safely ignored
        warnings.filterwarnings('ignore', category=UserWarning, module='pydantic')
        
        # Zep reserved names that must not be used as attribute names
    ...
    def add_text_batches(
        ...
        """Add text batches to the graph, return list of episode UUIDs"""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to be processed (poll each episode's processed status)"""
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            dict containing nodes and edges with timestamps and attributes
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
