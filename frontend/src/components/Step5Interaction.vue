...
const renderMarkdown = (content) => {
  ...
  // Handle lists - support nested sublists
  ...
  // Clean <p><br> occurrences immediately before block elements (caused by extra blank lines)
  ...
  // Fix numbering for non-contiguous ordered lists: keep numbering continuous when <ol> items are separated by paragraphs
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to response; prefer reddit platform replies
...
const submitSurvey = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Convert the object dictionary to an array format
...
/* Fix ordered list numbering - use CSS counters to keep multiple ols consecutively numbered */
.message-text {
