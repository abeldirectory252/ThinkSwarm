...
// Get `maxRounds` from query on init so child component gets it immediately
...
const loadGraph = async (graphId) => {
  // When simulating, avoid fullscreen loading during auto-refresh to prevent flicker
